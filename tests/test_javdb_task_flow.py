...
def test_run_detail_tasks_skips_without_fetch(monkeypatch):
    monkeypatch.setattr("spiders.javdb.javdb_spider.random_sleep", lambda *args: None)
...
def test_run_detail_tasks_retries_same_task_after_security(monkeypatch):
    monkeypatch.setattr("spiders.javdb.javdb_spider.fixed_sleep", lambda *args, **kwargs: None)
    monkeypatch.setattr("spiders.javdb.javdb_spider.random_sleep", lambda *args: None)
