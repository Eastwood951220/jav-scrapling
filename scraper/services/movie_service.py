...
class MovieService:
    ...
    def crawl_javdb_task(self, task: CrawlTask, stop_check=None, log_callback=None, on_item_saved=None, on_tasks_batch_created=None, on_detail_failed=None, db_check_callback=None, on_detail_check_callback=None, on_item_already_exists=None) -> dict:
        if task.is_skip:
            if log_callback:
